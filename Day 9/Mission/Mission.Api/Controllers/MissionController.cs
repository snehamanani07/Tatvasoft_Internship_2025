...
namespace Mission.Api.Controllers
{
    ...
    public class MissionController(IMissionService missionService, IWebHostEnvironment hostingEnvironment) : ControllerBase
    {
        ...
        public ResponseResult MissionApplicationApprove([FromBody] int id)
        {
            try
            {
                result.Data = _missionService.ApproveMission(id);
                result.Result = ResponseStatus.Success;
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        [Route("MissionApplicationDelete")]
        public ResponseResult MissionApplicationDelete([FromBody] int id)
        {
            ResponseResult result = new();

            try
            {
                result.Data = _missionService.DeleteMissionApplication(id);
                result.Result = ResponseStatus.Success;
            }
            catch (Exception ex)
            {
